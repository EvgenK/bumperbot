...
static const _LedSwitch_Request_type_support_symbol_names_t _LedSwitch_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, LedSwitch_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, srv, LedSwitch_Request)),
  }
};
...
{
  return &::my_robot_interfaces::srv::rosidl_typesupport_cpp::LedSwitch_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_robot_interfaces, srv, LedSwitch_Request)() {
  return get_message_type_support_handle<my_robot_interfaces::srv::LedSwitch_Request>();
}
...
static const _LedSwitch_Response_type_support_symbol_names_t _LedSwitch_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, LedSwitch_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, srv, LedSwitch_Response)),
  }
};
...
{
  return &::my_robot_interfaces::srv::rosidl_typesupport_cpp::LedSwitch_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_robot_interfaces, srv, LedSwitch_Response)() {
  return get_message_type_support_handle<my_robot_interfaces::srv::LedSwitch_Response>();
}
...
static const _LedSwitch_type_support_symbol_names_t _LedSwitch_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, srv, LedSwitch)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, srv, LedSwitch)),
  }
};
...
{
  return &::my_robot_interfaces::srv::rosidl_typesupport_cpp::LedSwitch_service_type_support_handle;
}
