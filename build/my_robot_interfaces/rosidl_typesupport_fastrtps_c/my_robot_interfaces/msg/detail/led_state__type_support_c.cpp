  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: led_one_is_active
  {
    cdr << (ros_message->led_one_is_active ? true : false);
  }

  // Field name: led_two_is_active
  {
    cdr << (ros_message->led_two_is_active ? true : false);
  }

  // Field name: led_three_is_active
  {
    cdr << (ros_message->led_three_is_active ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: led_one_is_active
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->led_one_is_active = tmp ? true : false;
  }
  ...
  // Field name: led_two_is_active
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->led_two_is_active = tmp ? true : false;
  }
  ...
  // Field name: led_three_is_active
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->led_three_is_active = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name led_one_is_active
  {
    size_t item_size = sizeof(ros_message->led_one_is_active);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name led_two_is_active
  {
    size_t item_size = sizeof(ros_message->led_two_is_active);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name led_three_is_active
  {
    size_t item_size = sizeof(ros_message->led_three_is_active);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    is_plain =
      (
      offsetof(DataType, led_three_is_active) +
      last_member_size
      ) == ret_val;
  }
