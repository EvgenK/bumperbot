...
my_robot_interfaces__msg__LedState__are_equal(const my_robot_interfaces__msg__LedState * lhs, const my_robot_interfaces__msg__LedState * rhs)
{
  ...
  // led_one_is_active
  if (lhs->led_one_is_active != rhs->led_one_is_active) {
    return false;
  }
  // led_two_is_active
  if (lhs->led_two_is_active != rhs->led_two_is_active) {
    return false;
  }
  // led_three_is_active
  if (lhs->led_three_is_active != rhs->led_three_is_active) {
    return false;
  }
  return true;
}
  ...
  my_robot_interfaces__msg__LedState * output)
{
  ...
  // led_one_is_active
  output->led_one_is_active = input->led_one_is_active;
  // led_two_is_active
  output->led_two_is_active = input->led_two_is_active;
  // led_three_is_active
  output->led_three_is_active = input->led_three_is_active;
  return true;
}
