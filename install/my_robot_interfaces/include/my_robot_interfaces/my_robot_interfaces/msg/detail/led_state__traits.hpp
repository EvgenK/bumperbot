  ...
  std::ostream & out)
{
  ...
  {
    out << "led_one_is_active: ";
    rosidl_generator_traits::value_to_yaml(msg.led_one_is_active, out);
    out << ", ";
  }

  // member: led_two_is_active
  {
    out << "led_two_is_active: ";
    rosidl_generator_traits::value_to_yaml(msg.led_two_is_active, out);
    out << ", ";
  }

  // member: led_three_is_active
  {
    out << "led_three_is_active: ";
    rosidl_generator_traits::value_to_yaml(msg.led_three_is_active, out);
  }
  out << "}";
