...
bool my_robot_interfaces__msg__led_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // led_one_is_active
    PyObject * field = PyObject_GetAttrString(_pymsg, "led_one_is_active");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->led_one_is_active = (Py_True == field);
    Py_DECREF(field);
  }
  {  // led_two_is_active
    PyObject * field = PyObject_GetAttrString(_pymsg, "led_two_is_active");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->led_two_is_active = (Py_True == field);
    Py_DECREF(field);
  }
  {  // led_three_is_active
    PyObject * field = PyObject_GetAttrString(_pymsg, "led_three_is_active");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->led_three_is_active = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * my_robot_interfaces__msg__led_state__convert_to_py(void * raw_ros_message)
{
  ...
  {  // led_one_is_active
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->led_one_is_active ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "led_one_is_active", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // led_two_is_active
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->led_two_is_active ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "led_two_is_active", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // led_three_is_active
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->led_three_is_active ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "led_three_is_active", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
